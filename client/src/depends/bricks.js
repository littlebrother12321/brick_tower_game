...
export const bricks = []; // freely mutable
let groundAtX = null; // user-defined function

/* ---------- SETUP ---------- */

export function physicsSetup(groundFunc, options = {}) {
...
export function addGroundSpan(xStart, xEnd, step = 10) {
  const thickness = 50;
...
export function physicsTick(dt = 1 / 60) {
  if (!engine) return;
